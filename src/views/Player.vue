...
<!--      </va-button>-->
      ...
      <article class="controlPanel" v-show="!hideControls">
        <div class="list-control">
          ...
          <div class="control-channel __next _selectable" ref="fav_btn" @keydown.enter="controlHandler('fav')">
            <template v-if="isFavoriteChannel">
              <div style="color: white; margin-bottom: -.5rem" class="flex align--end">
...
export default {
  ...
  computed: {
    ...
    isFavoriteChannel() {
      return this.favoritos?.filter(fav => fav.cn_id === this.currentCh.cn_id).length > 0
    }
  },
