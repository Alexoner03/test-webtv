<template>
    <va-navbar color="#222327" class="px-4">
        ...
        <template #right v-if="sidebarCanEnabled">
            <va-button class="mb-2" id="userbg" flat color="#ffffff" @click="sidebarRightActive = !sidebarRightActive"> {{
                username }} </va-button>
        </template>
        <template #right v-else>
            <va-button-dropdown class="mb-2" id="userbg" flat :label="username" color="#ffffff">
                <div id="usermenu">
                    <a href="#" @click="logout" class="px-4 py-2"><va-icon class="material-icons">logout</va-icon> Cerrar
                        Sesión</a>
                </div>
            </va-button-dropdown>
        </template>
                ...
                <va-sidebar-item id="favourite" @click="this.adultAllowed = false; favHidden = false">
                    <va-sidebar-item-content class="px-1 py-2">
                        <va-icon class="material-icons mr-5" :class="{ hidden: favHidden }"
                            @click.stop.prevent="this.adultAllowed = false; favHidden = true">arrow_back</va-icon>
