  ...
  <div class="row rew">
    ...
    <div class="flex md6 xs12 align--center justify--center d-flex">
      <div id="loginform">
        ...
        <br>
        <form method="POST" action="#" ref="formulario">
          <div class="mb-3 form-group">
            <label for="user">Correo Electrónico</label>
            <input type="email" class="form-field _selectable" v-model="user" id="user" name="user"
                   placeholder="Ej: micorreo@correo.cl" required>
          </div>
          <div class="mb-4 form-group">
            <label for="pass">Password</label>
            <input type="password" class="form-field _selectable" v-model="pass" id="pass" name="pass" placeholder="Ej: XXXXXXXX"
                   required>
          </div>
          <div>
...
export default {
  ...
  methods: {
    async inicioSesion(event = null) {

      if(event !== null && !this.$refs.formulario.checkValidity()) {
